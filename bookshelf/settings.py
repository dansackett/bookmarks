...
rel = lambda *args: os.path.abspath(os.path.join(REPO_PATH, *args))
...
SECRET_KEY = '&f%03aca&7rxh(rruo!b7qzj#-u8u0g6x@mr1hdfnsp+5h^g6r'
...
MIDDLEWARE_CLASSES = (
    ...
    # custom
    'bookshelf.middleware.require_login',
)
